...
public class LeProgressView extends View {
    ...
    public LeProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        radius = typedArray.getDimension(R.styleable.LeProgressView_le_radius, 50);
        pointCount = typedArray.getInt(R.styleable.LeProgressView_le_pointCount, 6);
        pointRadius = typedArray.getDimension(R.styleable.LeProgressView_le_pointRadius, 10);
        typedArray.recycle();
