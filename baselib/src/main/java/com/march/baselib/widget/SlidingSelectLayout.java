...
public class SlidingSelectLayout extends FrameLayout {
    ...
    private void publishSlidingCheck(MotionEvent event) {
        ...
        if (onSlidingSelectListener != null && childViewUnder != null) {
            ...
            if (pos != INVALID_PARAM && preViewPos != pos) {
                onSlidingSelectListener.onSlidingSelect(pos, childViewUnder);
                preViewPos = pos;
            }
        }
    }
    ...
    public void markView(View parentView, int pos) {
    ...
    public void setOnSlidingSelectListener(OnSlidingSelectListener onSlidingCheckListener) {
        this.onSlidingSelectListener = onSlidingCheckListener;
    }

    public interface OnSlidingSelectListener {
        void onSlidingSelect(int pos, View parentView);
    }
}
